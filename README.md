...
[![hacs_badge](https://img.shields.io/badge/HACS-Custom-41BDF5.svg?style=flat-square)](https://my.home-assistant.io/redirect/hacs_repository/?owner=1e1&repository=hass-deauth-guard&category=integration)
[![GitHub release](https://img.shields.io/github/v/release/1e1/hass-deauth-guard?style=flat-square)](https://github.com/1e1/hass-deauth-guard/releases)
[![GitHub commit activity](https://img.shields.io/github/commit-activity/m/1e1/hass-deauth-guard?style=flat-square&color=brightgreen)](https://github.com/1e1/hass-deauth-guard/commits/main)
[![License](https://img.shields.io/github/license/1e1/hass-deauth-guard?style=flat-square)](https://github.com/1e1/hass-deauth-guard/blob/main/LICENSE)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=1e1&repository=hass-deauth-guard&category=integration)

1. Click the button above **or** open HACS → Integrations → ⋮ → **Custom repositories**
2. Add `https://github.com/1e1/hass-deauth-guard` as **Integration**
